        ...
        return orderRepository.findById(orderId).map(order -> {
            ...
            try {
                if (savedOrder.getUser() != null && savedOrder.getUser().getEmail() != null) {
                    ...
                    String subject = "BuildPro Order Update: Order #" + orderNum + " is " + status;
                    String content = "Dear " + savedOrder.getUser().getName() + ",\n\n" +
                            "Your BuildPro order #" + orderNum + " status has been updated to: " + status + ".\n\n" +
                            "Order Summary:\n" +
                            "---------------------------------------\n" +
                            ...
                            "Thank you for choosing BuildPro!\n" +
                            "BuildPro Team";
